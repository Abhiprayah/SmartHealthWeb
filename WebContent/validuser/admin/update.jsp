...
<%@ page import="beans.User,beans.Admin" %>
...
<form method="post" action="/SmartHealthWeb/UpdateAdmin">
<table align="center" style="width: 50%">
	...
	<tr>
		...
		<td><input name="emergencyContact" type="text" value="<%= ((Admin)session.getAttribute("curUser")).getEmergencyContact() %>" /></td>
	</tr>
	<tr>
