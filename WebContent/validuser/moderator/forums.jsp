...
<br />
<p class="auto-style1"><a href="forum_creation.jsp">Create Forum</a></p>
<br />
...
for(ForumIdentifier f : forums){
	out.print("<tr>");
	out.print("<td>");
	out.print("<a href=\"/SmartHealthWeb/validuser/moderator/forum.jsp?id="+f.getForumID()+"\">"+f.getForumDesc()+"</a>");
	out.print("</td>");
	out.print("</tr>");
}
%>
