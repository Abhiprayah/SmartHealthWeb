...
<form method="post" action="SignUpModerator">
<table align="center" style="width: 50%">
	...
	<tr>
		<td class="auto-style5">Qualifications:&nbsp;<%=(new SignUp()).qualificationsToString()%></td>
		<td><input name="qualifications" type="text" /></td>
	</tr>
	<tr>
