...
public class SignUpAdmin extends HttpServlet implements UserForm{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User user = new Admin(commonDetails[FIRST_NAME],commonDetails[LAST_NAME],commonDetails[PRIMARY_EMAIL],
	...
	public String validateUser(User user){
		...
		if(((Admin)user).getEmergencyContact() == null || !isValidContactNumber( ((Admin)user).getEmergencyContact() )){
