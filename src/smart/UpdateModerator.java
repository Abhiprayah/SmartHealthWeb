...
public class UpdateModerator extends HttpServlet implements UserForm{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User user = new Moderator(commonDetails[FIRST_NAME],commonDetails[LAST_NAME], "",
		...
		if(errormessage == null && qualmessage == null){
			...
			((Moderator)curUser).setEmergencyContact(emergencyContact);
			model.updateHelper("Moderator", "Phone", emergencyContact, curUser.getUserId());
			((Moderator)curUser).setQualifications(qualifications);
			model.updateModeratorQualificationHelper(qualifications, curUser.getUserId());
	...
	public String validateUser(User user){
		...
		if(((Moderator)user).getEmergencyContact() == null || !this.isValidContactNumber(((Moderator)user).getEmergencyContact())){
